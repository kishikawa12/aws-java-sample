#!/bin/sh
# Posts a Dynatrace deployment event so charts get a marker line at the moment
# you cut over from SDK v1 to v2. Run this on the redeploy (Phase G).
#
# Required env vars:
...
#   DEPLOY_TITLE    event title shown on the timeline        (default "Migrate to AWS SDK v2")
...
DEPLOY_TITLE="${DEPLOY_TITLE:-Migrate to AWS SDK v2}"
